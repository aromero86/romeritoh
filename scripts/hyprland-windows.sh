...
# Floating window for bluetuith in kitty
windowrule = float,class:^(kitty)$,title:^(bluetuith)$
windowrule = size 1000 700,class:^(kitty)$,title:^(bluetuith)$
windowrule = center,class:^(kitty)$,title:^(bluetuith)$
